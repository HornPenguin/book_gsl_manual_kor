...
이 단원에서 기술하는 함수들은 희소 선형계를 풀기위한 기능들을 제공합니다.
이 함수들은 :type:`gsl_spmatrix` 와 :type:`gsl_vector`
객체들에 직접 접근해 계산합니다.

헤더 파일 :file:`gsl_splinalg.h` 에 정의되어 있습니다.
...
:math:`A` 는 일반적인 :math:`n \times n` 정사각 행렬
