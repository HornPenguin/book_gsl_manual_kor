...
.. c:type:: gsl_root_fsolver

 
    괄호법을 사용하는 근 탐색 알고리즘을 위한 풀이 공간입니다.

 
.. c:type:: gsl_root_fdfsolver

 
    도함수가 필요한 근 탐색 알고리즘(기울기 연마 방법)을 위한 풀이 공간입니다.

 
.. c:function:: gsl_root_fsolver * gsl_root_fsolver_alloc (const gsl_root_fsolver_type * T)
...
.. c:function:: gsl_root_fdfsolver * gsl_root_fdfsolver_alloc (const gsl_root_fdfsolver_type * T)
...
.. c:function:: int gsl_root_fsolver_set (gsl_root_fsolver * s, gsl_function * f, double x_lower, double x_upper)

 
    함수 :math:`f` 를 이용해 해를 찾는 풀이 공간 :math:`s` 에 대해 
    초기 탐색 구간을 [ :math:`x_lower`  :math:`x_upper` ] 로 잡고 풀이를 시작/재시작 시킵니다.

.. c:function:: int gsl_root_fdfsolver_set (gsl_root_fdfsolver * s, gsl_function_fdf * fdf, double root)

    함수 :math:`f` 와 그 도함수 :math:`fdf` 를 이용해 해를 찾는 풀이 공간 :math:`s` 에 대해 
    초기 추정 위치를 :math:`root` 로 잡고 풀이를 시작/재시작 시킵니다.

.. c:function:: void gsl_root_fsolver_free (gsl_root_fsolver * s)
...
.. c:function:: const char * gsl_root_fsolver_name (const gsl_root_fsolver * s)
...
.. c:function:: int gsl_root_fsolver_iterate (gsl_root_fsolver * s)
              int gsl_root_fdfsolver_iterate (gsl_root_fdfsolver * s)

 
    풀이공간 :math:`s` 대한 단일 반복을 수행합니다. 
    만약 반복 과정에서 예상치 못한 문제가 생기면, 다음의 오류 코드가 반환됩니다.
...
.. c:function:: double gsl_root_fsolver_root (const gsl_root_fsolver * s)
...
.. c:function:: double gsl_root_fsolver_x_lower (const gsl_root_fsolver * s)
...
.. c:function:: int gsl_root_test_interval (double x_lower, double x_upper, double epsabs, double epsrel)
...
.. c:function:: int gsl_root_test_delta (double x1, double x0, double epsabs, double epsrel)
...
.. c:function:: int gsl_root_test_residual (double f, double epsabs)
...
.. c:type:: gsl_root_fsolver_type


 
   .. c:var:: gsl_root_fsolver_type * gsl_root_fsolver_bisection
   ...
   .. c:var:: gsl_root_fsolver_type * gsl_root_fsolver_falsepos
   ...
   .. c:var:: gsl_root_fsolver_type * gsl_root_fsolver_brent
...
.. c:type:: gsl_root_fdfsolver_type

 
   .. c:var:: gsl_root_fdfsolver_type * gsl_root_fdfsolver_newton
   ...
   .. c:var:: gsl_root_fdfsolver_type * gsl_root_fdfsolver_secant
   ...
   .. c:var:: gsl_root_fdfsolver_type * gsl_root_fdfsolver_steffenson
