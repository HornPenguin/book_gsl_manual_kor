...
.. rst:directive:: .. c:marco:: GSL_RANGE_CHECK_OFF
...
.. function:: int gsl_matrix_fprintf (FILE * stream, const gsl_matrix * m, const char * format)
   ...
   0 for success and :c:marco:`GSL_EFAILED` if there was a problem writing to
   the file.
