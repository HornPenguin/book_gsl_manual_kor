...
.. c:function:: void gsl_matrix_minmax_index (const gsl_matrix * m, size_t * imin, size_t * jmin, size_t * imax, size_t * jmax)
   ...
   row-major order.void **gsl_matrix_minmax_index**(const gsl_matrix * *m*, size_t * *imin*, size_t * *jmin*, size_t * *imax*, size_t * *jmax*)
...
아래의 프로그램은 함수 :code:`gsl_matrix_alloc()` 와 :code:`gsl_mtrix_set()` 그리고 :code:`gsl_matrix_get()` 를 이용해 
