...
.. c:function:: gsl_block * gsl_block_alloc (size_t n)
...
.. c:function:: gsl_block * gsl_block_calloc (size_t n)

  모든 원소를 :math:`0` 으로 초기화한 블록을 가르키는 포인터를 반환합니다.


.. c:function:: void gsl_block_free (gsl_block * b)
...
.. c:function:: int gsl_block_fwrite (FILE * stream, const gsl_block * b)
...
.. c:function:: int gsl_block_fread (FILE * stream, gsl_block * b)
...
.. c:function:: int gsl_block_fprintf (FILE * stream, const gsl_block * b, const char * format)
...
.. c:function:: int gsl_block_fscanf (FILE * stream, gsl_block * b)
...
.. c:function:: gsl_vector * gsl_vector_alloc (size_t n)
...
.. c:function:: gsl_vector * gsl_vector_calloc (size_t n)


  길이 :math:`n`  의 벡터를 만들고, 벡터 구조체의 시작 지점을 가르키는 포인터를 반환합니다. 
  벡터의 모든 원소들은 :math:`0`  으로 초기화 되어있습니다.

.. c:function:: void gsl_vector_free (gsl_vector * v)
...
:code:`extern inline`  인라인 선언 되어 있습니다. 이러한 구조는 함수 호출 과정에서 오버헤드를 줄여줍니다. 
이를 위해서는 프로그램을 컴파일 할 때, 전처리기에서 매크로 :code:`HAVE_INLINE` 처리 하도록 선언해야합니다.


.. rst:directive:: .. c:macro:: GSL_RANGE_CHECK_OFF


  만약 필요한 경우 :code:`GSL_RANGE_CHECK_OFF` 정의해 재컴파일하면 코드의 수정 없이 모든 범위 확인 기능을 무시할 수 있습니다. 
  인라인 함수를 지원하는 컴파일러에서 이러한 범위 확인 기능을 끄는 것은 :code:`gsl_vector_get(v,i)` 와 :code:`gsl_vector_set(v,i,x)` 르 
...
.. c:function:: double gsl_vector_get (const gsl_vector * v, const size_t i)


  벡터 :code:`v` 의 :code:`i` 번째 원소를 반환합니다. 
  만약, :code:`i` 가 :math:`0` 에서 :code:`size-1` 밖에 있다면, 
  오류 관리자가 실행되고 :math:`0`  이 반환됩니다. 
  :code:`HAVE_INLINE` 이 정의된 경우에는 인라인 함수가 사용됩니다. 



.. c:function:: void gsl_vector_set (gsl_vector * v, const size_t i, double x)
...
.. c:function:: double * gsl_vector_ptr (gsl_vector * v, size_t i)
...
.. c:function:: void gsl_vector_set_all (gsl_vector * v, double x)

 벡터 :code:`v` 의 모든 원소를 주어진 값 :code:`x` 초기화합니다.

.. c:function:: void gsl_vector_set_zero (gsl_vector * v)

 벡터 :code:`v` 의 모든 원소를 :math:`0` 으로 초기화합니다.

.. c:function:: int gsl_vector_set_basis (gsl_vector * v, size_t i)
...
.. c:function:: int gsl_vector_fwrite (FILE * stream, const gsl_vector * v)
...
.. c:function:: int gsl_vector_fread (FILE * stream, gsl_vector * v)
...
.. c:function:: int gsl_vector_fprintf (FILE * stream, const gsl_vector * v, const char * format)
...
.. c:function:: int gsl_vector_fscanf (FILE * stream, gsl_vector * v)
...
.. c:function:: gsl_vector_view gsl_vector_subvector (gsl_vector * v, size_t offset, size_t n)
...
.. c:function:: gsl_vector_view gsl_vector_subvector_with_stride (gsl_vector * v, size_t offset, size_t stride, size_t n)
...
.. c:function:: gsl_vector_view gsl_vector_complex_real (gsl_vector_complex * v)
...
.. c:function:: gsl_vector_view gsl_vector_complex_imag (gsl_vector_complex * v)
...
.. c:function:: gsl_vector_view gsl_vector_view_array (double * base, size_t n) 
...
.. c:function:: gsl_vector_view gsl_vector_view_array_with_stride (double * base, size_t stride, size_t n)
...
.. c:function:: int gsl_vector_memcpy (gsl_vector * dest, const gsl_vector * src)

  벡터 :code:`src` 원소들을 :code:`dest` 벡터로 복사합니다. 
  이 두 벡터들은 같은 길이를 가져야합니다.

.. c:function:: int gsl_vector_swap (gsl_vector * v, gsl_vector * w)
...
.. c:function:: int gsl_vector_swap_elements (gsl_vector * v, size_t i, size_t j)

  벡터 :code:`v` 의 :code:`i` 번째와 :code:`j` 번째 원소들을 교환합니다.

.. c:function:: int gsl_vector_reverse (gsl_vector * v)
...
.. c:function:: int gsl_vector_add (gsl_vector * a, const gsl_vector * b)

   벡터 :code:`a` 와 벡터 :code:`b` 의 원소를 합합니다.
   :math:`a_i \leftarrow a_i + b_i` 값이 :code:`a` 벡터에 저장되며 :code:`b` 는 변하지 않습니다. 
   이 두 벡터들은 같은 길이를 가져야합니다.

.. c:function:: int gsl_vector_sub (gsl_vector * a, const gsl_vector * b)

   벡터 :code:`a` 와 벡터 :code:`b` 의 원소를 뺍니다.
   :math:`a_i \leftarrow a_i - b_i` 값이 :code:`a` 벡터에 저장되며 :code:`b` 는 변하지 않습니다. 
   이 두 벡터들은 같은 길이를 가져야합니다.

.. c:function:: int gsl_vector_mul (gsl_vector * a, const gsl_vector * b)

   벡터 :code:`a` 와 벡터 :code:`b` 의 원소를 곱합니다.
   :math:`a_i \leftarrow a_i * b_i` 값이 :code:`a` 벡터에 저장되며 :code:`b` 는 변하지 않습니다. 
   이 두 벡터들은 같은 길이를 가져야합니다.

.. c:function:: int gsl_vector_div (gsl_vector * a, const gsl_vector * b)

   벡터 :code:`a` 와 벡터 :code:`b` 의 원소를 나눕니다.
   :math:`a_i \leftarrow a_i / b_i` 값이 :code:`a` 벡터에 저장되며 :code:`b` 는 변하지 않습니다. 
   이 두 벡터들은 같은 길이를 가져야합니다.

.. c:function:: int gsl_vector_scale (gsl_vector * a, const double x)

   벡터 :code:`a` 원소들에 상수 계수 :code:`x` 를 곱합니다.
   :math:`a_i \leftarrow x a_i` 값이 :code:`a` 에 저장됩니다.

.. c:function:: int gsl_vector_add_constant (gsl_vector * a, const double x)

   벡터 :code:`a` 원소들에 상수 :code:`x` 를 더합니다.  
   :math:`a_i \leftarrow a_i + x` 값이 :code:`a` 에 저장됩니다.

.. c:function:: double gsl_vector_sum (const gsl_vector * a)

   주어진 벡터 :code:`a` 원소들의 합 :math:`\sum_{i=1}^n a_i` 을 반환합니다.

.. c:function:: int gsl_vector_axpby (const double alpha, const gsl_vector * x, const double beta, gsl_vector * y)
...
.. c:function:: double gsl_vector_max (const gsl_vector * v)

  벡터 :code:`v` 최댓값을 반환합니다.

.. c:function:: double gsl_vector_min (const gsl_vector * v)

  벡터 :code:`v` 최솟값을 반환합니다.

.. c:function:: void gsl_vector_minmax (const gsl_vector * v, double * min_out, double * max_out)

  벡터 :code:`v` 최댓값과 최솟값을 반환합니다. 
  해당 값들은 각각 :code:`min_out` 과 :code:`max_out` 포인터가 가르키는 공간에 저장됩니다.

.. c:function:: size_t gsl_vector_max_index (const gsl_vector * v)

  벡터 :code:`v` 최댓값인 원소의 위치를 반환합니다. 
  동일한 최댓값이 여럿 존재하는 경우 가장 작은 값이 반환됩니다.

.. c:function:: size_t gsl_vector_min_index (const gsl_vector * v)

  벡터 :code:`v` 최솟값인 원소의 위치를 반환합니다. 
  동일한 최솟값이 여럿 존재하는 경우 가장 작은 값이 반환됩니다.

.. c:function:: void gsl_vector_minmax_index (const gsl_vector * v, size_t * imin, size_t * imax)
...
.. c:function:: int gsl_vector_isnull (const gsl_vector * v)
...
.. c:function:: int gsl_vector_equal (const gsl_vector * u, const gsl_vector * v)
...
.. c:function:: gsl_matrix * gsl_matrix_alloc (size_t n1, size_t n2)
...
.. c:function:: gsl_matrix * gsl_matrix_calloc (size_t n1, size_t n2)
...
.. c:function:: void gsl_matrix_free (gsl_matrix * m)
...
.. c:function:: double gsl_matrix_get (const gsl_matrix * m, const size_t i, const size_t j)
...
.. c:function:: void gsl_matrix_set (gsl_matrix * m, const size_t i, const size_t j, double x)
...
.. c:function:: double * gsl_matrix_ptr (gsl_matrix * m, size_t i, size_t j)
...
.. c:function:: void gsl_matrix_set_all (gsl_matrix * m, double x)

   This function sets all the elements of the matrix :data:`m` to the value
   :data:`x`.

.. c:function:: void gsl_matrix_set_zero (gsl_matrix * m)

   This function sets all the elements of the matrix :data:`m` to zero.

.. c:function:: void gsl_matrix_set_identity (gsl_matrix * m)
...
.. c:function:: int gsl_matrix_fwrite (FILE * stream, const gsl_matrix * m)
   ...
   :c:macro:`GSL_EFAILED` if there was a problem writing to the file.  Since the
   data is written in the native binary format it may not be portable
   between different architectures.

.. c:function:: int gsl_matrix_fread (FILE * stream, gsl_matrix * m)
   ...
   :c:macro:`GSL_EFAILED` if there was a problem reading from the file.  The
   data is assumed to have been written in the native binary format on the
   same architecture.

.. c:function:: int gsl_matrix_fprintf (FILE * stream, const gsl_matrix * m, const char * format)
   ...
   0 for success and :c:macro:`GSL_EFAILED` if there was a problem writing to
   the file.

.. c:function:: int gsl_matrix_fscanf (FILE * stream, gsl_matrix * m)
   ...
   :c:macro:`GSL_EFAILED` if there was a problem reading from the file.
...
.. c:type:: gsl_matrix_view
   ...
   :c:type:`gsl_matrix_view` and a constant matrix view has the type
   :c:type:`gsl_matrix_const_view` .  In both cases the elements of the view
...
.. c:function:: gsl_matrix_view gsl_matrix_submatrix (gsl_matrix * m, size_t k1, size_t k2, size_t n1, size_t n2)
...
.. c:function:: gsl_matrix_view gsl_matrix_view_array (double * base, size_t n1, size_t n2)
...
.. c:function:: gsl_matrix_view gsl_matrix_view_array_with_tda (double * base, size_t n1, size_t n2, size_t tda)
...
.. c:function:: gsl_matrix_view gsl_matrix_view_vector (gsl_vector * v, size_t n1, size_t n2)
...
.. c:function:: gsl_matrix_view gsl_matrix_view_vector_with_tda (gsl_vector * v, size_t n1, size_t n2, size_t tda)
...
.. c:function:: gsl_vector_view gsl_matrix_row (gsl_matrix * m, size_t i)
...
.. c:function:: gsl_vector_view gsl_matrix_column (gsl_matrix * m, size_t j)
...
.. c:function:: gsl_vector_view gsl_matrix_subrow (gsl_matrix * m, size_t i, size_t offset, size_t n)
...
.. c:function:: gsl_vector_view gsl_matrix_subcolumn (gsl_matrix * m, size_t j, size_t offset, size_t n)
...
.. c:function:: gsl_vector_view gsl_matrix_diagonal (gsl_matrix * m)
...
.. c:function:: gsl_vector_view gsl_matrix_subdiagonal (gsl_matrix * m, size_t k) 
...
.. c:function:: gsl_vector_view gsl_matrix_superdiagonal (gsl_matrix * m, size_t k) 
...
.. c:function:: int gsl_matrix_memcpy (gsl_matrix * dest, const gsl_matrix * src)
...
.. c:function:: int gsl_matrix_swap (gsl_matrix * m1, gsl_matrix * m2)
...
.. c:function:: int gsl_matrix_get_row (gsl_vector * v, const gsl_matrix * m, size_t i)
...
.. c:function:: int gsl_matrix_get_col (gsl_vector * v, const gsl_matrix * m, size_t j)

   This function copies the elements of the :data:`j`-th column of the matrix
   :data:`m` into the vector :data:`v`.  The length of the vector must be the
   same as the length of the column.

.. c:function:: int gsl_matrix_set_row (gsl_matrix * m, size_t i, const gsl_vector * v)
...
.. c:function:: int gsl_matrix_set_col (gsl_matrix * m, size_t j, const gsl_vector * v)
...
.. c:function:: int gsl_matrix_swap_rows (gsl_matrix * m, size_t i, size_t j)

   This function exchanges the :data:`i`-th and :data:`j`-th rows of the matrix
   :data:`m` in-place.

.. c:function:: int gsl_matrix_swap_columns (gsl_matrix * m, size_t i, size_t j)

   This function exchanges the :data:`i`-th and :data:`j`-th columns of the
   matrix :data:`m` in-place.

.. c:function:: int gsl_matrix_swap_rowcol (gsl_matrix * m, size_t i, size_t j)
...
.. c:function:: int gsl_matrix_transpose_memcpy (gsl_matrix * dest, const gsl_matrix * src)
...
.. c:function:: int gsl_matrix_transpose (gsl_matrix * m)
...
.. c:function:: int gsl_matrix_complex_conjtrans_memcpy (gsl_matrix * dest, const gsl_matrix * src)
...
.. c:function:: int gsl_matrix_add (gsl_matrix * a, const gsl_matrix * b)
...
.. c:function:: int gsl_matrix_sub (gsl_matrix * a, const gsl_matrix * b)
...
.. c:function:: int gsl_matrix_mul_elements (gsl_matrix * a, const gsl_matrix * b)
...
.. c:function:: int gsl_matrix_div_elements (gsl_matrix * a, const gsl_matrix * b)
...
.. c:function:: int gsl_matrix_scale (gsl_matrix * a, const double x)

   This function multiplies the elements of matrix :data:`a` by the
   constant factor :data:`x`.  The result :math:`a(i,j) \leftarrow x a(i,j)`
   is stored in :data:`a`.

.. c:function:: int gsl_matrix_scale_columns (gsl_matrix * A, const gsl_vector * x)
...
.. c:function:: int gsl_matrix_scale_rows (gsl_matrix * A, const gsl_vector * x)
...
.. c:function:: int gsl_matrix_add_constant (gsl_matrix * a, const double x)
...
.. c:function:: double gsl_matrix_max (const gsl_matrix * m)

   This function returns the maximum value in the matrix :data:`m`.

.. c:function:: double gsl_matrix_min (const gsl_matrix * m)

   This function returns the minimum value in the matrix :data:`m`.

.. c:function:: void gsl_matrix_minmax (const gsl_matrix * m, double * min_out, double * max_out)

   This function returns the minimum and maximum values in the matrix
   :data:`m`, storing them in :data:`min_out` and :data:`max_out`.

.. c:function:: void gsl_matrix_max_index (const gsl_matrix * m, size_t * imax, size_t * jmax)
...
.. c:function:: void gsl_matrix_min_index (const gsl_matrix * m, size_t * imin, size_t * jmin)
...
.. c:function:: void gsl_matrix_minmax_index (const gsl_matrix * m, size_t * imin, size_t * jmin, size_t * imax, size_t * jmax)
...
.. c:function:: int gsl_matrix_isnull (const gsl_matrix * m)
...
.. c:function:: int gsl_matrix_equal (const gsl_matrix * a, const gsl_matrix * b)

  행렬 :code:`a` :code:`b`  원소를 비교해서 같은 행렬이면 
  :math:`1`  을 아니면 :math:`0` 을 반환합니다.

.. c:function:: double gsl_matrix_norm1 (const gsl_matrix * A)
