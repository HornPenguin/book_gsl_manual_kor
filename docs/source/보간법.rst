...
:c:type:`gsl_interp` object.  These are created by the following functions.

.. c:type:: gsl_interp

   Workspace for 1D interpolation

.. c:function:: gsl_interp * gsl_interp_alloc (const gsl_interp_type * T, size_t size)

   This function returns a pointer to a newly allocated interpolation
   object of type :data:`T` for :data:`size` data-points.

.. c:function:: int gsl_interp_init (gsl_interp * interp, const double xa[], const double ya[], size_t size)
   ...
   :data:`size`.  The interpolation object (:c:type:`gsl_interp`) does not save
...
.. c:function:: void gsl_interp_free (gsl_interp * interp)
...
.. c:type:: gsl_interp_type

   .. index:: linear interpolation

   .. c:var:: gsl_interp_type * gsl_interp_linear
   ...
   .. c:var:: gsl_interp_type * gsl_interp_polynomial
   ...
   .. c:var:: gsl_interp_type * gsl_interp_cspline
   ...
   .. c:var:: gsl_interp_type * gsl_interp_cspline_periodic
...
.. c:function:: const char * gsl_interp_name (const gsl_interp * interp)
...
.. c:function:: unsigned int gsl_interp_min_size (const gsl_interp * interp)
...
The state of searches can be stored in a :c:type:`gsl_interp_accel` object,
which is a kind of iterator for interpolation lookups.

.. c:type:: gsl_interp_accel
...
.. c:function:: size_t gsl_interp_bsearch (const double x_array[], double x, size_t index_lo, size_t index_hi)
...
.. c:function:: gsl_interp_accel * gsl_interp_accel_alloc (void)
...
.. c:function:: size_t gsl_interp_accel_find (gsl_interp_accel * a, const double x_array[], size_t size, double x)
...
.. c:function:: int gsl_interp_accel_reset (gsl_interp_accel * acc);
...
.. c:function:: void gsl_interp_accel_free (gsl_interp_accel* acc)
...
.. c:function::  double gsl_interp_eval (const gsl_interp * interp, const double xa[], const double ya[], double x, gsl_interp_accel * acc)
   ...
   :c:macro:`GSL_EDOM` is returned with a value of :c:macro:`GSL_NAN` for
   :data:`y`.

.. c:function:: double gsl_interp_eval_deriv (const gsl_interp * interp, const double xa[], const double ya[], double x, gsl_interp_accel * acc)
...
.. c:function:: double gsl_interp_eval_deriv2 (const gsl_interp * interp, const double xa[], const double ya[], double x, gsl_interp_accel * acc)
...
.. c:function:: double gsl_interp_eval_integ (const gsl_interp * interp, const double xa[], const double ya[], double a, double b, gsl_interp_accel * acc)
...
:c:type:`gsl_interp` functions but maintain a copy of this data in the
:c:type:`gsl_spline` object.  This removes the need to pass both :data:`xa`
...
.. c:type:: gsl_spline
   ...
   :c:type:`gsl_interp` object

.. c:function:: gsl_spline * gsl_spline_alloc (const gsl_interp_type * T, size_t size)

.. c:function:: int gsl_spline_init (gsl_spline * spline, const double xa[], const double ya[], size_t size)

.. c:function:: void gsl_spline_free (gsl_spline * spline)

.. c:function:: const char * gsl_spline_name (const gsl_spline * spline)

.. c:function:: unsigned int gsl_spline_min_size (const gsl_spline * spline)

.. c:function:: double gsl_spline_eval (const gsl_spline * spline, double x, gsl_interp_accel * acc)
              int gsl_spline_eval_e (const gsl_spline * spline, double x, gsl_interp_accel * acc, double * y)

.. c:function:: double gsl_spline_eval_deriv (const gsl_spline * spline, double x, gsl_interp_accel * acc)
              int gsl_spline_eval_deriv_e (const gsl_spline * spline, double x, gsl_interp_accel * acc, double * d)

.. c:function:: double gsl_spline_eval_deriv2 (const gsl_spline * spline, double x, gsl_interp_accel * acc)
              int gsl_spline_eval_deriv2_e (const gsl_spline * spline, double x, gsl_interp_accel * acc, double * d2)

.. c:function:: double gsl_spline_eval_integ (const gsl_spline * spline, double a, double b, gsl_interp_accel * acc)
...
The interpolation function for a given dataset is stored in a
:c:type:`gsl_interp2d` object. These are created by the following functions.

.. c:type:: gsl_interp2d

   Workspace for 2D interpolation

.. c:function:: gsl_interp2d * gsl_interp2d_alloc (const gsl_interp2d_type * T, const size_t xsize, const size_t ysize)
...
.. c:function:: int gsl_interp2d_init (gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const size_t xsize, const size_t ysize)
   ...
   :data:`xsize` * :data:`ysize`.  The interpolation object (:c:type:`gsl_interp2d`) does
...
.. c:function:: void gsl_interp2d_free (gsl_interp2d * interp)
...
.. c:function:: int gsl_interp2d_set (const gsl_interp2d * interp, double za[], const size_t i, const size_t j, const double z)

   This function sets the value :math:`z_{ij}` for grid point
   (:data:`i`, :data:`j`) of the array :data:`za` to :data:`z`.

.. c:function:: double gsl_interp2d_get (const gsl_interp2d * interp, const double za[], const size_t i, const size_t j)

   This function returns the value :math:`z_{ij}` for grid point
   (:data:`i`, :data:`j`) stored in the array :data:`za`.

.. c:function:: size_t gsl_interp2d_idx (const gsl_interp2d * interp, const size_t i, const size_t j)
...
.. c:type:: gsl_interp2d_type
   ...
   .. c:var:: gsl_interp2d_type * gsl_interp2d_bicubic

      Bicubic interpolation.

.. c:function:: const char * gsl_interp2d_name (const gsl_interp2d * interp)
...
.. c:function:: unsigned int gsl_interp2d_min_size (const gsl_interp2d * interp)
...
.. c:function:: double gsl_interp2d_eval (const gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
   ...
   :c:macro:`GSL_EDOM` is returned.

.. c:function:: double gsl_interp2d_eval_extrap (const gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_interp2d_eval_deriv_x (const gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_interp2d_eval_deriv_y (const gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_interp2d_eval_deriv_xx (const gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_interp2d_eval_deriv_yy (const gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_interp2d_eval_deriv_xy (const gsl_interp2d * interp, const double xa[], const double ya[], const double za[], const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
:c:type:`gsl_spline2d` object.  This removes the need to pass :data:`xa`,
...
.. c:type:: gsl_spline2d
   ...
   This workspace provides a higher level interface for the
   :c:type:`gsl_interp2d` object

.. c:function:: gsl_spline2d * gsl_spline2d_alloc (const gsl_interp2d_type * T, size_t xsize, size_t ysize)

.. c:function:: int gsl_spline2d_init (gsl_spline2d * spline, const double xa[], const double ya[], const double za[], size_t xsize, size_t ysize)

.. c:function:: void gsl_spline2d_free (gsl_spline2d * spline)

.. c:function:: const char * gsl_spline2d_name (const gsl_spline2d * spline)

.. c:function:: unsigned int gsl_spline2d_min_size (const gsl_spline2d * spline)

.. c:function:: double gsl_spline2d_eval (const gsl_spline2d * spline, const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_spline2d_eval_extrap (const gsl_spline2d * spline, const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_spline2d_eval_deriv_x (const gsl_spline2d * spline, const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_spline2d_eval_deriv_y (const gsl_spline2d * spline, const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_spline2d_eval_deriv_xx (const gsl_spline2d * spline, const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_spline2d_eval_deriv_yy (const gsl_spline2d * spline, const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: double gsl_spline2d_eval_deriv_xy (const gsl_spline2d * spline, const double x, const double y, gsl_interp_accel * xacc, gsl_interp_accel * yacc)
...
.. c:function:: int gsl_spline2d_set (const gsl_spline2d * spline, double za[], const size_t i, const size_t j, const double z)

.. c:function:: double gsl_spline2d_get (const gsl_spline2d * spline, const double za[], const size_t i, const size_t j)
