...
예를 들어서 :math:`gsl_sf_airy.h` 나 :math:`gsl_sf_bessel.h` 로 각각 나뉘어져 있습니다. 
모두 포함시켜서 계산하려면, :math:`gsl_sf.h` 을 포함시키면 됩니다.
...
이 구조체는 헤더파일 :math:`gsl_sf_result.h` 정의되어 있습니다.
...
이러한 경우에 :type:`gsl_mode_t` 자료형으로 정의된 :code:`mode` 인자를 이용해 요구 정밀도를 낮추어 연산 효율을 높일 수 있습니다. 다음의 정밀도 값들이 :math:`mode`  인자에 들어갈 수 있습니다.
...
================================================
.. include:: 특수 함수-airy.rst

베셀 함수(Bessel function)
================================
.. include:: 특수 함수-bessel.rst
